...
//    }
    ...
    public synchronized void addNotification(Notifications notify) {
        if (notify != null) {
            notification.add(notify);
        }
    }

    public synchronized List<Notifications> getNotifications() {
        return new ArrayList<>(notification);
    }

    public synchronized List<Notifications> getNotificationList() {
        return notification;
